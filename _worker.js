...
// 建议修改为自己的 UUID
let userID = '4d0d81ec-29d6-4fcb-b922-686bf9d91123';

// 生成配置文件的 CF 优选 IP
const bestCFIP = "www.gov.se"

// 用于 CF 网站的代理 IP
const proxyIPs = ["workers.cloudflare.cyo"]; // const proxyIPs = ['cdn-all.xn--b6gac.eu.org', 'cdn.xn--b6gac.eu.org', 'cdn-b100.xn--b6gac.eu.org', 'edgetunnel.anycast.eu.org', 'cdn.anycast.eu.org'];
